	...
	Else
		...
		If MsSeek(xFilial("SF1")+cNota+cSerie+cClieFor+cLoja)
			...
			BeginSql Alias cAliasSD1			
					SELECT D1_FILIAL,D1_DOC,D1_SERIE,D1_FORNECE,D1_LOJA,D1_COD,D1_ITEM,D1_TES,D1_TIPO,D1_NFORI,D1_SERIORI,D1_ITEMORI,D1_EMISSAO,
...
If  !lIssQn
	...
	ELse
		...
		If (aCST[01] = "60" .or. cCsosn$ "500")	.And. cTipo == "1"	
			...
			If Empty(cUltAqui) .And. cEmpAnt $ "14"
				sfSPEDRastro(aProd[02],@nBaseST60,@nValST60,aProd[09],@nAliqST60,@nBfcpant,@nAfcpant,@nVfcpant,@nVlIcmSubst)
				If lCalcMed
			...
			If (nBaseIcm > 0 .and. nValICM > 0	.and. nAlqICM > 0) .Or. nBaseST60 > 0
		   		If Len(cMensFis) > 0 .And. SubStr(cMensFis, Len(cMensFis), 1) <> " "
					cMensFis += " "
				EndIf
